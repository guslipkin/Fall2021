...
---
* Name: JJ
* Replicated from prof. Rei's slide.
* Date: Nov 16, 2021
...
```{r, message=FALSE}
rmp <- read_csv("https://raw.githubusercontent.com/reisanar/datasets/master/rmp_wit_comments.csv");head(rmp)
```
...
```{r}
rmp %>%
unnest_tokens(trigram, comments, token = "ngrams"
, n = 3) %>%
...
```{r, message=FALSE}
bb_lyrics <- read_csv("https://raw.githubusercontent.com/reisanar/datasets/master/BB_top100_2015.csv"); head(bb_lyrics)
```
### bigrams count
